...
### Способ 1: Автоматическая установка (Linux/macOS)
...
- **Запрашивает** Telegram токен бота и **ваш Chat ID**
- Опционально запрашивает API ключи (Groq, Gemini)
- Создает виртуальное окружение Python
- Опционально создает systemd сервис для автозапуска
